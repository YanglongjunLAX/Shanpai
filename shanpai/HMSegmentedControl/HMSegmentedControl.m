...
- (CGRect)frameForSelectionIndicator {
    ...
    if (self.selectionIndicatorMode == HMSelectionIndicatorResizesToStringWidth) {
        ...
        //updated
        return CGRectMake(x, self.height-2, stringWidth, self.selectionIndicatorHeight);
    } else {
        
        //updated
        return CGRectMake(self.segmentWidth * self.selectedIndex, self.height-2, self.segmentWidth, self.selectionIndicatorHeight);
    }
}
